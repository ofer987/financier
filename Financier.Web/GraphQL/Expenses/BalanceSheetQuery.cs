...
{
    public class BalanceSheetQuery : ObjectGraphType
    {
        ...
        public BalanceSheetQuery()
        {
            Field<ListGraphType<MonthlyPaymentType>>(
                ...
                resolve: context =>
                {
                    ...
                    var financialStatement = new PrepayableMortgageBuilder(mortgage).Build();
                    ...
                    return financialStatement.GetMonthlyPayments()
