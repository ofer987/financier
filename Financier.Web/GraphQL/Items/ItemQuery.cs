...
public class ClaimsUserContext : Dictionary<string, object?>
{
    public ClaimsPrincipal User { get; private set; }

    public ClaimsUserContext(ClaimsPrincipal user)
    {
        User = user;
    }
}
...
public class ItemQuery : ObjectGraphType
{
    ...
    public ItemQuery()
    {
        ...
        Field<ListGraphType<ItemType>>(
            ...
            resolve: context =>
            {
                var userContext = context.UserContext as ClaimsUserContext;
